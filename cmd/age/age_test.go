...
var buildExtraCommands = sync.OnceValue(func() error {
	...
	cmd.Args = append(cmd.Args, "github.com/hanzoai/age/cmd/age-keygen")
	cmd.Args = append(cmd.Args, "github.com/hanzoai/age/extra/age-plugin-pq")
	cmd.Args = append(cmd.Args, "github.com/hanzoai/age/cmd/age-plugin-batchpass")
